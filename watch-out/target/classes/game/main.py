...
BG = pygame.image.load("src/main/java/game/assets/Background.png")

def get_font(size): # Returns Press-Start-2P in the desired size
    return pygame.font.Font("src/main/java/game/assets/font.ttf", size)

pygame.display.set_caption("Test1")
W,B=(255, 255, 255), (0,0,0)
FPS=90
OWN_PG_H, OWN_PG_W, BULLET_VEL= 70, 70, 8
OWN_PG_img = pygame.image.load(os.path.join("src/main/java/game/assets/circle.png"))
OWN_PG_img=pygame.transform.scale(OWN_PG_img, (OWN_PG_W,OWN_PG_H))
ENEMY_PG_img = pygame.image.load(os.path.join("src/main/java/game/assets/square.png")) 
...
def main_menu():
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("src/main/java/game/assets/Play Rect.png"), pos=(640, 250), 
                            text_input="PLAY", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        OPTIONS_BUTTON = Button(image=pygame.image.load("src/main/java/game/assets/Options Rect.png"), pos=(640, 400), 
                            text_input="OPTIONS", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("src/main/java/game/assets/Quit Rect.png"), pos=(640, 550), 
