...
Playimage=pygame.transform.scale(Playimage, PlaySize)
...
def background_window(OWN_PG_img, OWN_PG, ENEMY_PG, ENEMY_PG_img, EXIT, MENU_MOUSE_POS):
    ...
    global ENEMY_bullets, CANFIRE, OWN_bullets, FIRED, ENEMY_NUMBER, PG_HP, backImage
...
def set_level():
    ...
    PLAY_BUTTON = Button(image, pos=(660, 560), text_input="PLAY", font=get_font(30), base_color=W, hovering_color="#ddffd0")
    ButtonLevelUp = Button(arrowImageUp, pos= (WIDTH/2+170, HEIGHT/2+100), text_input="", font=get_font(30), base_color=B, hovering_color="#ddffd0") 
    ButtonLevelDown = Button(arrowImageDown, pos= (WIDTH/2-138, HEIGHT/2+100), text_input="", font=get_font(30), base_color=B, hovering_color="#ddffd0") 
...
def main_menu():
    ...
    pos, count = 0, 0
    global BESTSCORE, EASY_DIFF, Playimage, PlaySize, OptionSize,imageOption
    ...
    PLAY_BUTTON = Button(Playimage, pos=(630, 310), text_input="PLAY", font=get_font(50), base_color=W, hovering_color="#ddffd0", size=(PlaySize, 50))

    CHANGE_DIFFICULT = Button(imageOption, pos=(400, 440), text_input="SET EASY", font=get_font(26), base_color=W, hovering_color="#ddffd0", size=(OptionSize, 25))
    SELECT_LEVEL = Button(imageOption, pos=(870, 440), text_input="SELECT LEVEL", font=get_font(26), base_color=W, hovering_color="#ddffd0", size=(OptionSize, 25))
    QUIT_BUTTON = Button(imageOption, pos=(640, 560), text_input="QUIT", font=get_font(45), base_color=W, hovering_color="#ddffd0", size=(OptionSize, 45))


    while True:
        MENU_MOUSE_POS = pygame.mouse.get_pos()
        CHANGE_DIFFICULT = Button(Playimage, pos=(400, 440), text_input="SET EASY", font=get_font(25), base_color=W, hovering_color="#ddffd0")
        ...
        for button in [PLAY_BUTTON, CHANGE_DIFFICULT,SELECT_LEVEL, QUIT_BUTTON]:
            ...
            (button.mouseOver(MENU_MOUSE_POS,SIZE[i][0],SIZE[i][1])).update(WIN)
